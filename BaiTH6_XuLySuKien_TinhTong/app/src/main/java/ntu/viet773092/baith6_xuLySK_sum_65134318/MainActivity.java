package ntu.viet773092.baith6_xuLySK_sum_65134318;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void XuLyCong(View view) {
        ...
        try {
            ...
            int num_a = Integer.parseInt(strA); // 7
            int num_b = Integer.parseInt(strB); // 3

            // Sum a & b
            int sum = num_a + num_b; // Tong cua 2 so Nguyen (7 + 3 = 10)
